...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final int WATCH_MOVIE_NOTIFICATIION_ID=1000;
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.btnWatchMovie:
                postNotificationToUserDevice(WATCH_MOVIE_NOTIFICATIION_ID,edtWatchMovie.getText().toString());
                break;
    ...
    private void postNotificationToUserDevice(int notificationID,String titleText){
        ...
        switch (notificationID){
            case WATCH_MOVIE_NOTIFICATIION_ID:
        ...
        if (notificationBuilder!=null){
            notificationHandler.notifyTheUser(WATCH_MOVIE_NOTIFICATIION_ID,notificationBuilder);
        }
    }
